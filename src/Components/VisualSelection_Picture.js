      ...
      <main className="welcome-main">
        ...
        <div className="intro-container intro-selection">
          ...
          <div className="security-box-selection">
              ...
              This step verifies your identity, ensuring that only you can update your vote by recognising the vote identifiers shown to you after your previous voting session(s).<br /><br />
              This step also protects against coercion. If you are coerced, you can select wrong vote identifiers after casting your true vote or later update your vote by selecting the correct vote identifier(s).<br /><br />
              If you cannot remember your vote identifier(s), you can always vote in person at your local polling station.<br /><br />
